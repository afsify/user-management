...
function Home() {
    ...
    return (
            <div>
                ...
                <h3 className="fw-bold text-black pt-2 px-4">
                    WELCOME
                </h3>
                <button
                ...
                >
                    ...
                    <li className="nav-item">
                        <span style={{cursor:'pointer' , color:'blue'}} onClick={()=>navigate('/profile')} className="nav-link text-black fw-bold">
                        Profile
                        </span>
                    </li>
                    </ul>
                    ...
                    <Button type="primary" className='fw-bold text-dark' onClick={handleLogout}>
                      Logout
                    </Button>
                    </div>
                </nav>
              ...
              <div className="row">
                ...
                <div className="col-md-3 col-sm-6 item">
                  <div className="card item-card card-block bg-dark text-white">
                    ...
                    />
                    <div className='p-2'>
                    <h5 className="card-title  mt-3 mb-3">5G Technology Advancements</h5>
                    <p className="card-text">
                    5G networks drive innovations in autonomous vehicles and smart cities.
                    </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-3 col-sm-6 item">
                  <div className="card item-card card-block bg-dark text-white">
                    ...
                    />
                    <div className='p-2'>
                    <h5 className="card-title  mt-3 mb-3">Emerging Cybersecurity</h5>
                    <p className="card-text">
                        AI systems detect and prevent sophisticated cyber threats in time.
                    </p>
                    </div>
                  </div>
                </div>
