            ...
            <div className="container py-5 h-100">
                ...
                <div className="col-12 col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div className="card-body p-5 text-center ">
                        ...
                        <Button type="primary" shape='round' size='large' className='px-5 mt-4 h1 fw-bold' htmlType='submit'>Sign Up</Button>
                        </Form>
                        </div>
                        <div>
                        <p className="mb-0">
                            Already have an account?{" "}
                            <a style={{cursor:'pointer' , color:'blue'}} className='fw-bold text-decoration-none' onClick={()=>navigate('/sign-in')}>Sign In</a>
                        </p>
                        </div>
                    </div>
                    </div>
